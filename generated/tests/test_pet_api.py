...
def test_add_pet(client: TestClient):
    ...
    """
    pet = {"photo_urls":["photoUrls","photoUrls"],"name":"doggie","id":10,"category":{"name":"Dogs","id":1},"tags":[{"name":"name","id":0},{"name":"name","id":0}],"status":"available"}
...
def test_update_pet_with_form(client: TestClient):
    ...
    """
    params = [("name", 'name_example'),     ("status", 'status_example')]
    headers = {
        "Authorization": "Bearer special-key",
    }
    # uncomment below to make a request
